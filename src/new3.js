...
var myData = {};
var ep = "https://min-api.cryptocompare.com/data/pricemultifull?fsyms=BTC&tsyms=USD";
var ep2 = "https://min-api.cryptocompare.com/data/all/coinlist";
/*
function getData() {
    ...
    xhr.onloadend = function() {
        ...
        for (var key in data["Data"]) {
            ...
            var name = coins["CoinName"];
            var fullName = coin["FullName"];
            var sym = coin["Name"];
            var temp = new Object();
...
function buildElements() {
    ...
    //intervalId = setInterval(function() { foo() }, 500);
}
...
//Data collection
function foo() {
    console.log("running", intervalId === null);
}
